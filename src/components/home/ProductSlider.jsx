  ...
  return (
    <div className="w-full inline-block">
      <div className="bg-gray-100 py-3 text-center">
        <h2 className="w-full text-base md:text-lg lg:text-[26pxgit ] text-[#000]  text-center font-Poppins uppercase">
          {name}{" "}
        </h2>
      </div>
      ...
      <div>
        {products.length > 0 && (
          <div
            className="flex items-start mb-14 justify-center"
            onClick={showMore}
          >
