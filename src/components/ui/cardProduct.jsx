...
const CardProduct = ({
  ...
  return (
    <>
      <div
        className={`relative left-0 top-0 pb-[35px] animate__animated animate__zoomIn cursor-pointer`}
        ...
        <div className="block">
          <div className={`block-pick overflow-hidden relative  max-h-full `}>
            ...
            <div
              ...
              } transition-all	duration-[0.4s] ease-linear delay-0`}
            >
              <div className="absolute left-2/4 translate-x-[-50%]  bottom-[-50px] w-[161px] transition-all	duration-[0.4s] ease-linear delay-0">
                ...
                <button
                  className={`${
                    !opacity && "block-btn"
                  } rounded-3xl bg-[#222] min-w-[139px] h-10 font-Poppins leading-[1.4] text-luz absolute bottom-[-50px] left-[50%] translate-x-[-50%] flex justify-center items-center px-4 hover:bottom-10 hover:border-[#222] hover:no-underline hover:overflow-visible cursor-pointer transition-all	duration-[0.4s] ease-linear delay-0`}
                  onClick={() => handleClickCard(url)}
                >
                  {titleButton}
                </button>
